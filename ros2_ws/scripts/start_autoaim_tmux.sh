...
tmux_cmd new-session -d -s rm_det "env REMOTE_WS='${REMOTE_WS}' REMOTE_SRC_DIR='${REMOTE_SRC_DIR}' REMOTE_SCRIPT_DIR='${REMOTE_SCRIPT_DIR}' bash '${REMOTE_SCRIPT_DIR}/run_rm_det_loop.sh'"
tmux_cmd new-session -d -s rm_vis "env REMOTE_WS='${REMOTE_WS}' REMOTE_SRC_DIR='${REMOTE_SRC_DIR}' REMOTE_SCRIPT_DIR='${REMOTE_SCRIPT_DIR}' DISPLAY_VALUE='${DISPLAY_VALUE:-:0}' XAUTHORITY_VALUE='${XAUTHORITY_VALUE:-/home/sunrise/.Xauthority}' XDG_RUNTIME_DIR_VALUE='${XDG_RUNTIME_DIR_VALUE:-/run/user/1000}' VIS_DELAY_SEC='${VIS_DELAY_SEC:-3}' bash '${REMOTE_SCRIPT_DIR}/run_rm_vis_loop.sh'"
