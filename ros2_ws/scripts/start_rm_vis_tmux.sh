...
tmux -L "${TMUX_SOCKET}" new-session -d -s rm_vis \
  "env REMOTE_WS='${REMOTE_WS}' REMOTE_SRC_DIR='${REMOTE_SRC_DIR}' REMOTE_SCRIPT_DIR='${REMOTE_SCRIPT_DIR}' DETECTOR_TOPIC='${DETECTOR_TOPIC}' DISPLAY_VALUE='${DISPLAY_VALUE}' XAUTHORITY_VALUE='${XAUTHORITY_VALUE}' XDG_RUNTIME_DIR_VALUE='${XDG_RUNTIME_DIR_VALUE}' VIS_DELAY_SEC='${VIS_DELAY_SEC}' VIS_MAX_FPS='${VIS_MAX_FPS}' VIS_SCALE='${VIS_SCALE}' VIS_DEBUG_TOPIC='${VIS_DEBUG_TOPIC}' VIS_SHOW_DEBUG_TEXT='${VIS_SHOW_DEBUG_TEXT}' VIS_FULLSCREEN='${VIS_FULLSCREEN}' VIS_KEEP_ASPECT_RATIO='${VIS_KEEP_ASPECT_RATIO}' VIS_WINDOW_WIDTH='${VIS_WINDOW_WIDTH}' VIS_WINDOW_HEIGHT='${VIS_WINDOW_HEIGHT}' bash '${REMOTE_SCRIPT_DIR}/run_rm_vis_loop.sh'"
