...
MEASUREMENT_JITTER_DEADBAND_PX="${MEASUREMENT_JITTER_DEADBAND_PX:-34.0}"
FAST_FOLLOW_ERROR_PX="${FAST_FOLLOW_ERROR_PX:-80.0}"
FAST_FOLLOW_SMOOTHING_ALPHA="${FAST_FOLLOW_SMOOTHING_ALPHA:-1.00}"
FAST_FOLLOW_MAX_STEP_PX="${FAST_FOLLOW_MAX_STEP_PX:-160.0}"
LIGHT_FOLLOW_GAIN="${LIGHT_FOLLOW_GAIN:-0.85}"
...
BRIDGE_MIN_CONFIDENCE="${BRIDGE_MIN_CONFIDENCE:-0.35}"
