...
void BMI088_accel_read_over(uint8_t *rx_buf, float accel[3], float *time)
{
  ...
  accel[X_MAP] = bmi088_raw_temp * BMI088_ACCEL_SEN * X_DIR;
  bmi088_raw_temp = (int16_t)((rx_buf[3]) << 8) | rx_buf[2];
  accel[Y_MAP] = bmi088_raw_temp * BMI088_ACCEL_SEN * Y_DIR;
  bmi088_raw_temp = (int16_t)((rx_buf[5]) << 8) | rx_buf[4];
  accel[Z_MAP] = bmi088_raw_temp * BMI088_ACCEL_SEN * Z_DIR;
...
void BMI088_gyro_read_over(uint8_t *rx_buf, float gyro[3])
{
  int16_t bmi088_raw_temp;
  bmi088_raw_temp = (int16_t)((rx_buf[1]) << 8) | rx_buf[0];
  gyro[X_MAP] = bmi088_raw_temp * BMI088_GYRO_SEN * X_DIR;
  bmi088_raw_temp = (int16_t)((rx_buf[3]) << 8) | rx_buf[2];
  gyro[Y_MAP] = bmi088_raw_temp * BMI088_GYRO_SEN * Y_DIR;
  bmi088_raw_temp = (int16_t)((rx_buf[5]) << 8) | rx_buf[4];
  gyro[Z_MAP] = bmi088_raw_temp * BMI088_GYRO_SEN * Z_DIR;
}
...
void BMI088_read(float gyro[3], float accel[3], float *temperate)
{
  ...
  accel[X_MAP] = bmi088_raw_temp * BMI088_ACCEL_SEN * Z_DIR;
...
void get_BMI088_gyro(int16_t gyro[3])
{
  ...
  gyro[X_MAP] = gyro_raw_temp * X_DIR;
  gyro_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
  gyro[Y_MAP] = gyro_raw_temp * Y_DIR;
  gyro_raw_temp = (int16_t)((buf[5]) << 8) | buf[4];
  gyro[Z_MAP] = gyro_raw_temp * Z_DIR;
}
...
void get_BMI088_accel(float accel[3])
{
  ...
  accel[X_MAP] = accel_raw_temp * BMI088_ACCEL_SEN * X_DIR;
  accel_raw_temp = (int16_t)((buf[3]) << 8) | buf[2];
  accel[Y_MAP] = accel_raw_temp * BMI088_ACCEL_SEN * Y_DIR;
  accel_raw_temp = (int16_t)((buf[5]) << 8) | buf[4];
  accel[Z_MAP] = accel_raw_temp * BMI088_ACCEL_SEN * Z_DIR;
}
