...
This directory is reserved for training workflow helpers.

Current workflows:

- `hik_yolo_vehicle/`: migrated YOLOv8 vehicle detection training, evaluation, and Hikrobot realtime UI workflow
...
- scaffold plus migrated HIK vehicle workflow
